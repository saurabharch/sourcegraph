import { BillingInterval } from './testData'

// humanizeBillingInterval returns the singular form of the billing interval, e.g.
// "day", "month", or "year".
export function humanizeBillingInterval(interval: BillingInterval): string {
    switch (interval) {
